...
STORE result WITH EMPTY OBJECT
FOR i FROM 0 TO LENGTH OF arr - 1 WITH INCREMENT 1
    IF result WITH KEY arr[i] EQUAL TO UNDEFINED
        STORE result WITH KEY arr[i] AS NUMBER WITH 0
    END IF
    SET result WITH KEY arr[i] WITH INCREMENT 1
END FOR LOOP
